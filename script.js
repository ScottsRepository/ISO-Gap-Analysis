...
function calculateResults() {
    ...
    let color = "red-bg";
    let statusText = "Status: Red. High risk identified. Fundamental management controls appear to be missing.";
    
    if (ratio > 0.8) { color = "green-bg"; statusText = "Status: Green. Strong foundations. Ready for professional verification."; }
    else if (ratio > 0.45) { color = "amber-bg"; statusText = "Status: Amber. Foundations exist, but critical gaps in evidence or strategy were noted."; }
